...
async function init() {
    try {
        ...
        state.data = timeData.crimes; // Store the array of frames directly
        ...
        mapContainer.append("div").text("Error loading data. Please check console.");
    }
}
...
function setupControls() {
    ...
    // Initialize selected types (select all by default)
